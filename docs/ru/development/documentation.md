...
относительным путём. English canonical для identifiers и terminology; Russian
содержит полный перевод. Не переводите class names, paths, parameters,
environment variables, error names и commands.
