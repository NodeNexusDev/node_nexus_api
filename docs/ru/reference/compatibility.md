...
| 0.10.0 | 2026-08-12 | Minor | Реальные метрики Docker контейнеров на дашборде |
| 0.9.0 | 2026-08-12 | Minor | Endpoint дашборда, фильтры аудита по пользователю и дате, bulk выполнение по тегам |
