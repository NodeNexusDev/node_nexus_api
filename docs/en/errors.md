...
| Status | Title | When |
|---|---|---|
| `409` | Conflict | The template registry already exists (`code: RegistryConflictError`) |
...
| Status | Title | When |
|---|---|---|
| `404` | Not Found | The template registry does not exist (`code: RegistryNotFoundError`) |
